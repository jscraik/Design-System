...
- Web app smoke: `pnpm -C apps/web dev -- --port 5173` (verify `/harness`, `/settings`, `/profile`, `/about`).
- Storybook smoke: `pnpm -C apps/storybook dev` (confirm port 6006 availability or alternate).
