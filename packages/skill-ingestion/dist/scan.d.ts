...
export declare function scanSkills(basePath: string, storageKey: string, platform?: SkillPlatform): ScanResult[];
...
export declare function buildSkillSummary(scanned: ScanResult, platform?: SkillPlatform, customPath?: string): SkillSummary;
export {};
