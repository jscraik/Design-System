...
Complete reference for all aStudio components with interactive examples and prop documentation.
...
```tsx
<Button className="bg-accent-purple text-accent-foreground hover:bg-accent-purple/90">
  Custom Button
</Button>
```
...
```tsx
<Button style={{ "--button-radius": "0.75rem" }}>Custom Radius</Button>
```
