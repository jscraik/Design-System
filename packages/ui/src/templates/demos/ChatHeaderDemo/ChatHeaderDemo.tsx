    ...
    <div className="h-full bg-background overflow-auto">
      <div className="max-w-6xl mx-auto p-8 space-y-8">
        <div className="space-y-2">
          <h2 className="text-foreground">Basic Chat Header</h2>
        ...
        <div className="space-y-2">
          <h2 className="text-foreground">Compose Mode</h2>
          <p className="text-text-secondary">Header in compose mode - model selector is hidden</p>
          <div className="border border-border rounded-lg overflow-hidden bg-secondary">
            <ChatHeader
              onSidebarToggle={() => {}}
        ...
        <div className="space-y-2">
          <h2 className="text-foreground">With Custom Header Actions</h2>
          <p className="text-text-secondary">Add custom buttons using the headerRight slot</p>
          <div className="border border-border rounded-lg overflow-hidden bg-secondary">
            <ChatHeader
              onSidebarToggle={() => {}}
        ...
        <div className="space-y-2">
          <h2 className="text-foreground">With Share Button</h2>
          <p className="text-text-secondary">Header with additional sharing functionality</p>
          <div className="border border-border rounded-lg overflow-hidden bg-secondary">
            <ChatHeader
              onSidebarToggle={() => {}}
        ...
        <div className="space-y-2">
          <h2 className="text-foreground">Full Example in Context</h2>
          <p className="text-text-secondary">
            Complete chat interface with header and content area
          </p>
          <div className="border border-border rounded-lg overflow-hidden bg-secondary h-[500px] flex flex-col">
            <ChatHeader
              onSidebarToggle={() => {}}
              selectedModel={model1}
              onModelChange={(model) => setModel1(typeof model === "string" ? model : model.name)}
              ...
              headerRight={
                <button className="p-1.5 hover:bg-muted rounded-md transition-colors">
                  <IconDotsHorizontal className="size-4 text-muted-foreground" />
                </button>
              }
            />
              ...
              <div className="max-w-3xl mx-auto space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 pt-1">
                    <p className="text-foreground">How do I use the ChatHeader component?</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 pt-1 space-y-3">
                    ...
                    <div className="bg-muted rounded-lg p-4 font-mono text-[12px]">
...
/>`}
                    ...
                    <p className="text-foreground">Key features include:</p>
        ...
        <div className="space-y-2">
          <h2 className="text-foreground">Different Header Right Configurations</h2>
          <p className="text-text-secondary">Various examples of custom header actions</p>
          <div className="grid grid-cols-1 gap-4">
              ...
              <ChatHeader
                ...
                headerRight={
                  <div className="flex items-center gap-2 px-3 py-1.5 bg-muted rounded-lg">
                    ...
                    <span className="text-[13px] text-text-secondary">Private</span>
                  </div>
                }
              />
            ...
            <div className="border border-border rounded-lg overflow-hidden bg-secondary">
              <ChatHeader
                ...
                onViewModeChange={() => {}}
                headerRight={
                  <div className="flex items-center gap-2 px-3 py-1.5 bg-accent-green-light/10 dark:bg-accent-green/10 rounded-lg">
                    <IconGlobe className="size-3.5 text-accent-green-light dark:text-accent-green" />
                    <span className="text-[13px] text-accent-green-light dark:text-accent-green">
                      Public
                    </span>
                  </div>
                }
            ...
            <div className="border border-border rounded-lg overflow-hidden bg-secondary">
              <ChatHeader
                ...
                headerRight={
                  <>
                    <button className="px-3 py-1.5 text-[13px] text-text-secondary hover:bg-muted rounded-lg transition-colors">
                      Save
                    </button>
