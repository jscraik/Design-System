        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-foundation-bg-light-2 dark:bg-foundation-bg-dark-2 rounded-2xl border border-foundation-bg-light-3 dark:border-foundation-bg-dark-3 p-8">
            ...
            <div className="flex items-center gap-6 mb-6">
              <div
                className={`p-6 rounded-2xl bg-foundation-bg-light-3 dark:bg-foundation-bg-dark-3 ${colorClass} transition-all duration-200`}
              >
          ...
          <div className="bg-foundation-bg-light-2 dark:bg-foundation-bg-dark-2 rounded-2xl border border-foundation-bg-light-3 dark:border-foundation-bg-dark-3 p-8">
            ...
            <ul className="space-y-3 text-[14px] font-normal leading-[18px] tracking-[-0.3px] text-foundation-text-light-secondary dark:text-foundation-text-dark-secondary">
              <li className="flex items-start gap-3">
                <svg
                  className="size-5 text-foundation-accent-green-light dark:text-foundation-accent-green flex-shrink-0 mt-0.5"
                  fill="none"
                  viewBox="0 0 24 24"
                  strokeWidth={2}
                  stroke="currentColor"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              return (
                ...
                >
                  <div
                    className={`p-3 rounded-xl bg-foundation-bg-light-3 dark:bg-foundation-bg-dark-3 inline-flex mb-3 ${useCaseColor}`}
                  >
