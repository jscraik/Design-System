  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: colors.background.dark.primary }}>
      <div className="mx-auto max-w-7xl">
        ...
        {/* Controls */}
        <div
          className="mb-8 rounded-xl border p-6 space-y-4"
          style={{
        ...
        >
          ...
          <div>
            <label
              ...
              style={{ color: colors.text.dark.primary }}
            >
              Search Icons
            </label>
            <input
        ...
        >
          ...
          >
            <p>
              <span style={{ color: colors.accent.dark.green }}>import</span> {`{ IconCheckmark }`}{" "}
              <span style={{ color: colors.accent.dark.green }}>from</span> './icons/ChatGPTIcons';
            </p>
            ...
            <p>
              {`<IconCheckmark `}
              <span style={{ color: colors.accent.dark.green }}>className</span>=
              <span style={{ color: colors.text.dark.primary }}>"size-6"</span> {`/>`}
            </p>
          </div>
        </div>
      </div>
