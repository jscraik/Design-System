...
function SectionHeader({
  ...
  return (
    <>
      ...
      <p
        className={descriptionClassName || "text-caption text-foundation-text-dark-secondary mb-3"}
      >
        {description}
      </p>
    </>
    ...
    <div className="flex items-start justify-between">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <div className="text-caption text-foundation-text-dark-secondary">{description}</div>
        </div>
      </div>
      <button
        onClick={onToggle}
          ...
          <div>
            ...
            <div className="mt-3">
              ...
              >
                ...
                <span className="ml-auto text-foundation-text-dark-secondary">
                  {autoPlanBudget}k
                </span>
              </button>
