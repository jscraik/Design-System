 ...
 */
export function getEasing(token) {
    return easing[token];
}
/**
 * Helper to get duration value
 */
export function getDuration(token) {
    return duration[token];
}
/**
 * Helper to build CSS transition string
 */
export function transition(properties, options) {
 ...
 */
export function getMotion(element, phase) {
    const elementTokens = motionTokens[element];
 ...
 */
export function hoverTransition(properties = "transform") {
    const props = Array.isArray(properties) ? properties.join(", ") : properties;
 ...
 */
export function pressTransition(properties = "transform") {
    const props = Array.isArray(properties) ? properties.join(", ") : properties;
