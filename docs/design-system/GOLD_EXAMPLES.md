...
| `async-data-view-product-composition`   | `async_collection`         | `packages/ui/src/storybook/_holding/component-stories/ProductComposition.stories.tsx` | ready, loading, empty, error | Shows `ProductDataView` owning a collection heading and state routing.          |
