...
const GOLD_STANDARD_REFERENCES = [
  ...
  "components-chat-chat-ui-root--loading-overlay",
  "components-chat-chat-ui-root--error-overlay",
  "components-ui-layout-product-composition--data-view-ready",
  "components-ui-layout-product-composition--data-view-loading",
  "components-ui-layout-product-composition--data-view-empty",
  "components-ui-layout-product-composition--data-view-error",
  "components-ui-layout-product-composition--page-shell-with-sidebar-and-footer",
