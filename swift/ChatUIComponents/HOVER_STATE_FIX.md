...
1. Build Component Gallery: `swift build` in `apps/macos/ComponentGallery`
...
- `swift/ChatUIComponents/Sources/ChatUIComponents/SettingRowView.swift` - Fixed
- `swift/ChatUIComponents/Sources/ChatUIComponents/ListItemView.swift` - Already correct
- `swift/ChatUIFoundation/Sources/ChatUIFoundation/Platform.swift` - Platform detection
- `swift/ChatUIThemes/Sources/ChatUIThemes/ChatGPTTheme.swift` - Hover opacity constants
- `swift/ChatUIComponents/Tests/ChatUIComponentsTests/ChatUIComponentsTests.swift` - Tests added
