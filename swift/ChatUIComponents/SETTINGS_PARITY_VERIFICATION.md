...
- **SettingsDivider**: `swift/ChatUIComponents/Sources/ChatUIComponents/SettingsDivider.swift`
- **SettingsCardView**: `swift/ChatUIComponents/Sources/ChatUIComponents/SettingsCardView.swift`
- **SettingRowView**: `swift/ChatUIComponents/Sources/ChatUIComponents/SettingRowView.swift`
- **FoundationSwitchStyle**: `swift/ChatUIComponents/Sources/ChatUIComponents/FoundationSwitchStyle.swift`
- **SettingToggleView**: `swift/ChatUIComponents/Sources/ChatUIComponents/SettingToggleView.swift`
- **SettingDropdownView**: `swift/ChatUIComponents/Sources/ChatUIComponents/SettingDropdownView.swift`
- **SettingsExampleView**: `swift/ChatUIComponents/Sources/ChatUIComponents/SettingsExampleView.swift`

### React Components Location

- **SettingRow**: `packages/ui/src/app/components/settings/SettingRow.tsx`
- **SettingToggle**: `packages/ui/src/app/components/settings/SettingToggle.tsx`
- **SettingDropdown**: `packages/ui/src/app/components/settings/SettingDropdown.tsx`
- **SettingsModal**: `packages/ui/src/app/components/modals/SettingsModal.tsx`

### Component Gallery Integration

The SwiftUI settings primitives are fully integrated into the Component Gallery app:

- **Location**: `apps/macos/ComponentGallery/Sources/Galleries/SettingsGallery.swift`
- **Features**:
...
1. **Open Component Gallery**: Run `apps/macos/ComponentGallery` in Xcode
...
- **Location**: `swift/ChatUIComponents/Tests/ChatUIComponentsTests/`
- **Coverage**: SettingRowView, FoundationSwitchStyle, SettingToggleView, SettingDropdownView
- **Run**: `swift test` in `swift/ChatUIComponents/`
