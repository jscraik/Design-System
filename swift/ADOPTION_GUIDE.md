...
3. Click "Add Local..."
4. Navigate to the `swift/` directory in the repository
...
let package = Package(
    ...
    dependencies: [
        ...
        .package(path: "../swift/ChatUIShellChatGPT"), // Optional
    ],
    targets: [
        .target(
            name: "MyApp",
...
1. **Explore the Component Gallery**: Run `apps/macos/ComponentGallery` to see all components in action
