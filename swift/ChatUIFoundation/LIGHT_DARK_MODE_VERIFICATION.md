...
**Location:** `swift/ChatUIFoundation/Sources/ChatUIFoundation/Resources/Colors.xcassets/`
...
**File:** `swift/ChatUIFoundation/Sources/ChatUIFoundation/FColor.swift`
...
**File:** `swift/ChatUIComponents/Sources/ChatUIComponents/SettingsDivider.swift`
...
**File:** `swift/ChatUIComponents/Sources/ChatUIComponents/SettingsCardView.swift`
...
**File:** `swift/ChatUIComponents/Sources/ChatUIComponents/SettingRowView.swift`
...
```bash
ls -la swift/ChatUIFoundation/Sources/ChatUIFoundation/Resources/Colors.xcassets/
```
...
**File:** `swift/ChatUIComponents/Sources/ChatUIComponents/SettingsExampleView.swift`
...
1. **Open Component Gallery:**
   ...
   ```bash
   open apps/macos/ComponentGallery/Package.swift
   ```
...
**Unit Tests:** `swift/ChatUIComponents/Tests/ChatUIComponentsTests/`
...
- Asset Catalog Verification: `swift/ChatUIFoundation/ASSET_CATALOG_VERIFICATION.md`
- Phase 1 Checkpoint: `swift/PHASE_1_CHECKPOINT_VERIFICATION.md`
