...
1. Open Xcode
2. Navigate to `swift/ChatUIFoundation/Sources/ChatUIFoundation/`
...
4. Outputs to `swift/ChatUIFoundation/Sources/ChatUIFoundation/Resources/Colors.xcassets/`
...
2. **Check File Permissions**:
   ...
   chmod -R u+w swift/ChatUIFoundation/Sources/ChatUIFoundation/Resources/
   ```
...
```bash
git add swift/ChatUIFoundation/Sources/ChatUIFoundation/Resources/Colors.xcassets/
