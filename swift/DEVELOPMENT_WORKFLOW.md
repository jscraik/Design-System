...
│   ├── ChatUIThemes/
│   └── ChatUIShellChatGPT/
├── apps/macos/ComponentGallery/    # Development app
...
1. **Create Component File:**
   ...
   ```bash
   cd swift/ChatUIComponents/Sources/ChatUIComponents
...
4. **Commit Changes:**
   ...
   git add swift/ChatUIFoundation/Sources/ChatUIFoundation/Resources/
