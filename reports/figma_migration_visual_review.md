...
**Created:** 2026-01-02  
**Purpose:** Now that the templates gallery is driven by the canonical `@design-studio/ui` sources (and `_temp/**` is archived), this backlog tracks **visual parity + polish** items to review and iterate after functional consolidation.
