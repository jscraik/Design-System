...
// ../../../../node_modules/.pnpm/react-resizable-panels@4.5.9_react-dom@19.0.0_react@19.0.0__react@19.0.0/node_modules/react-resizable-panels/dist/react-resizable-panels.js
...
function Mt(e) {
  ...
  }), V.get(m) === 1 && (m.addEventListener("dblclick", be, true), m.addEventListener("pointerdown", Le, true), m.addEventListener("pointerleave", Ee), m.addEventListener("pointermove", ke), m.addEventListener("pointerout", Ge), m.addEventListener("pointerup", Ie, true)), function() {
    t = false, V.set(
      m,
      ...
      Le,
      true
    ), m.removeEventListener("pointerleave", Ee), m.removeEventListener("pointermove", ke), m.removeEventListener("pointerout", Ge), m.removeEventListener("pointerup", Ie, true)), r.disconnect();
  };
}
function Et() {
...
function It({
  ...
  }), g = me(s), v = (0, import_react.useRef)(null), [z, y] = Et(), b = (0, import_react.useRef)({
  ...
  }), (0, import_jsx_runtime.jsx)(Je.Provider, { value: H, children: (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...m,
      className: t,
...
function Ht({
  ...
  const i = t !== void 0, r = "id" in o ? o.id : o.groupId, l = ce(r, t ?? []), s = (0, import_react.useSyncExternalStore)(
    Dt,
    () => n.getItem(l),
    () => n.getItem(l)
  ...
  const h = (0, import_react.useCallback)(
    (m) => {
      u();
      let f;
...
function Tt({
  ...
  const m = !!l, f = me(l), d = (0, import_react.useRef)(null), p = he(d, r), { getPanelStyles: g, id: v, registerPanel: z } = ge(), y = c !== null, b = q(
    (w, H, N) => {
      c?.(w, l, N);
    }
  );
  ...
  const C = (0, import_react.useSyncExternalStore)(
...
function At({
  ...
  const l = me(o), [s, a] = (0, import_react.useState)({}), [c, u] = (0, import_react.useState)("inactive"), h = (0, import_react.useRef)(null), S = he(h, n), {
    id: m,
    orientation: f,
    registerSeparator: d
