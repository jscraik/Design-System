...
## Structure
- `apps/macos/`: macOS apps (ComponentGallery, AStudioPlayground, AStudioApp)
...
2. Run Swift tests from any package, for example `cd platforms/apple/swift/AStudioFoundation && swift test`
