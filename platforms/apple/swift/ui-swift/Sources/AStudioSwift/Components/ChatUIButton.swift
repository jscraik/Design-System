...
@available(*, deprecated, message: "Use AStudioComponents.ChatUIButtonVariant instead. This API will be removed in a future release.")
...
@available(*, deprecated, message: "Use AStudioComponents.ChatUIButtonSize instead. This API will be removed in a future release.")
...
///
/// **Deprecation Notice:**
/// This component is deprecated. Please use `AStudioComponents.ChatUIButton` instead.
/// The ui-swift package is legacy and new features should use AStudioComponents.
///
/// **Migration Guide:**
/// ```swift
/// // Old (deprecated)
...
///
/// **Why Migrate?**
/// - AStudioComponents supports iOS, macOS, and visionOS
/// - Better token integration with AStudioFoundation
/// - More comprehensive accessibility support
/// - Property-based testing for higher reliability
@available(*, deprecated, message: "Use AStudioComponents.ChatUIButton instead. This component will be removed in ui-swift version 2.0.")
