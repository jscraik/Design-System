import XCTest
import SwiftUI
@testable import AStudioSwift

final class AStudioSwiftTests: XCTestCase {
    ...
    func testPackageInitialization() throws {
        ...
        XCTAssertNoThrow(AStudioSwift.initialize())
        
        // Test package metadata
        XCTAssertEqual(AStudioSwift.name, "AStudioSwift")
        XCTAssertEqual(AStudioSwift.version, "1.0.0")
    }
