...
public class AppLifecycleManager {
    ...
    public init() {
        ...
        var targetDirectory = baseDirectory.appendingPathComponent("aStudio/State", isDirectory: true)
        
        do {
            try fileManager.createDirectory(at: targetDirectory, withIntermediateDirectories: true)
        } catch {
            // Fall back to a temporary directory if Application Support is unavailable.
            targetDirectory = fileManager.temporaryDirectory.appendingPathComponent("aStudio/State", isDirectory: true)
            try? fileManager.createDirectory(at: targetDirectory, withIntermediateDirectories: true)
        }
