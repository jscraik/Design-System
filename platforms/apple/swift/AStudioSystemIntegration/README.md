...
AStudioSystemIntegration provides a comprehensive set of managers for integrating with native macOS and iOS system features. This package handles platform-specific APIs and provides a unified interface for common system integration tasks.
...
Add AStudioSystemIntegration to your `Package.swift`:

```swift
dependencies: [
    .package(path: "../AStudioSystemIntegration")
]
```
...
3. Select AStudioSystemIntegration
...
- Domain-based organization (com.astudio.messages)
...
- Build: `cd platforms/apple/swift/AStudioSystemIntegration && swift build`
...
- **AStudioFoundation**: Design tokens and platform utilities
- **AStudioComponents**: Reusable SwiftUI components
- **AStudioThemes**: Theme presets and styling
- **AStudioMCP**: MCP tool integration
