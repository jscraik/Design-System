...
AStudioFoundation is the foundation layer of the aStudio Swift package architecture. It provides semantic design tokens through Asset Catalog integration, typography styles matching React components, platform detection utilities, and comprehensive accessibility helpers.
...
Add AStudioFoundation as a dependency in your `Package.swift`:
...
- Build the package: `cd platforms/apple/swift/AStudioFoundation && swift build`
- Import `AStudioFoundation` in a SwiftUI view and reference `FColor` / `FType`.
...
AStudioFoundation follows these principles:
