...
## Recent Changes
- **2026-02-21:** Added baseline governance controls for governance/security evidence (GOVERNANCE scope docs, COMPLIANCE data-handling, SECURITY threat model, exceptions/incidents register), added `.github/workflows/gov-security-gates.yml` and `.github/scripts/gov_security_gates.py`, plus standardized PR template evidence sections and branch protection manifest for evidence-first review.
