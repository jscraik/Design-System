...
- `docs/plans/2026-05-02-agent-first-design-system-simplification-plan.md` remains the active HE delivery plan for the simplification spec. P0-P8 are recorded in its execution ledger; the next work packet is P9 session-evidence traceability.
